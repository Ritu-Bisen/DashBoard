...
const handleClear = () => {
  ...
  const onHandleSubmit = (e) => {
   ...
   dispatch(createEmployee({ formData, sellerDetails }));
    handleClear();
  };
  ...
  return (
    <div className=" w-[calc(100%-300px)] ml-[300px] h-screen flex flex-col pt-[120px]  ">
                    ...
                    <div className="flex flex-col">
                      ...
                      {designationOptions[section] && (
                        ...
                        >
                          ...
                          {designationOptions[section].map((role, index) => (
