...
const ViewOrderDetails = ({onClose,orders}) => {
    console.log(orders)
  return (
        ...
        <table className='mt-5 bg-white rounded-xl'>
            ...
            <tbody>
                <tr>
                    ...
                    <td className="border-gray-300 border p-2 px-5">{orders.mart_products.id}</td>
                </tr>
                <tr>
                    <th className="border-gray-300 border p-2 px-5">Product Name :</th>
                    <td className="border-gray-300 border p-2 px-5">{orders.mart_products.name}</td>
                </tr>
                <tr>
                    <th className="border-gray-300 border p-2 px-5">Discount %:</th>
                    <td className="border-gray-300 border p-2 px-5">{orders.mart_products.discount_percentage}</td>
                </tr>
                <tr>
                    <th className="border-gray-300 border p-2 px-5">Discounted Price :</th>
                    <td className="border-gray-300 border p-2 px-5">{orders.mart_products.discounted_price}</td>
                </tr>
                <tr>
                    <th className="border-gray-300 border p-2 px-5">Price :</th>
                    <td className="border-gray-300 border p-2 px-5">{orders.mart_products.price}</td>
                </tr>
                <tr>
