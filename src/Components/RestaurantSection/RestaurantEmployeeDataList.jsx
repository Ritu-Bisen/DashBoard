...
import { getRestaurantEmployeeList } from '../../Redux/Slices/restaurantSlice/restaurantemployeeSlice';
import RestaurantViewEmployeeDetails from './RestaurantViewEmployeeDetails';

const RestaurantEmployeeDataList = () => {
...
useEffect(() => {
  dispatch(getRestaurantEmployeeList())
}, [dispatch])
...
export default RestaurantEmployeeDataList
