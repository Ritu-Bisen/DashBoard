...
const SalonHeader = () => {
  return (
    ...
    <div className= "fixed top-0 w-full  left-0  flex justify-between py-5 px-12 border-b bg-white border-gray-300 shadow-xl z-50 shadow-gray-300 rounded-br-4xl rounded-bl-4xl">
