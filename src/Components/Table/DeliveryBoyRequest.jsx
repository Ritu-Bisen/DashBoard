...
const DeliveryBoyRequest = () => {
    ...
    const columns = [
      ...
      const data =Array(25).fill({
        ...
        status:<div className='space-x-4 text-white font-semibold'><button className='bg-green-700 p-2 rounded-lg'>Approval</button><button className='bg-red-500 py-2 px-5 rounded-lg'>Reject</button></div>,
      })
